...
df = pd.DataFrame(columns=['negative_word_count', 'positive_word_count', 'vander_score','happ_score','Sentiment'])
...
#print(df)
df.to_csv('..\\Data\\training_data_new.csv',index_label='doc_id')
